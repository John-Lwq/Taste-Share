...
<style>
	...
	.one_one{width:239px;height:400px;float:left;margin-right:30px;overflow:hidden;}
...
/*    one-two*/
	...
	.one_three{margin-left:100px;float:left;width:622px;}
...
<div class="one">
<div class="one_one">
	<div class="one_one_tupian" ><img src="${menu.imgUrl}" style="width: 300px;"></div>
...
<div class="one_three">
 ...
 <hr/>
 <div class="diaopai">菜名：${menu.name}</div>
 <hr/>
 <div class="cuxiao" >材料：${menu.ingredients}</div>
...
<div class="middle">
      ...
      <div class="one">
		  ...
		  <div class="hengxian_wenzi">制作流程</div>
...
<font size="3"  face="微软雅黑"></font>
    ...
    <span data-hook="review-body" class="a-size-base review-text">
    <font size="3"  face="宋体">${menu.tips}</font>
	</div>
	</div>
<!--  盒子内容结束-->
