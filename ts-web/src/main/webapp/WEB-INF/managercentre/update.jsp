...
<style>
	...
	.weibo{background-../../staticfile/image:url(../../staticfile/../../staticfile/image2/weibo.png);background-size:cover;}
	.weixing{background-../../staticfile/image:url(../../staticfile/../../staticfile/image2/weixing.png);background-size:cover;}
	.kongjian{background-../../staticfile/image:url(../../staticfile/../../staticfile/image2/kongjian.png);background-size:cover;}
	.qq{background-../../staticfile/image:url(../../staticfile/../../staticfile/image2/QQ.png);background-size:cover;}
...
/*    one-two*/
	...
	.shoucangjia{width:200px;height:50px;border:1px solid black;text-align:center;float:left;background-../../staticfile/image:url(../../staticfile/image2/xingxing.png);
...
/*商品评价*/
	...
	.fuwu{text-align:center;width:1320px;margin:0 auto;background-../../staticfile/image:url(../../staticfile/image2/fuwu.png);background-repeat:no-repeat;
	...
	.baozheng,.tuihuo,.kefu{float:left;background-../../staticfile/image:url(../../staticfile/image2/fuwu_baozheng.png);background-repeat:no-repeat;width:calc((100%)/3);text-align:center;background-position:40px center;padding:5px 0;}
	.tuihuo{background-../../staticfile/image:url(../../staticfile/image2/fuwu_tuihuo.png);}
	.kefu{background-../../staticfile/image:url(../../staticfile/image2/fuwu_kefu.png);}
	...
	<script type="text/javascript">
			var formObj={
				...
				"checkForm":function(){
					...
					// 非空验证
					flag=this.checkNull("shopName","商家信息不能为空")&&flag;
					flag=this.checkNull("shopaddress","商家地址不能为空")&&flag;
					return flag;
				}
			};
			...
			$(function(){
				...
				$("input[name='shopName']").blur(function(){
					formObj.checkNull("shopName","商家信息不能为空");
				});
				$("input[name='shopaddress']").blur(function(){
					formObj.checkNull("shopaddress","商家地址不能为空");
				});
...
/* 				// ajax校验
				$("input[name='shopName']").blur(function(){
					...
					var flag=formObj.checkNull("shopName","商家信息不能为空");
					if(flag){
						// 发送一个AJAX请求
						
						
						var url="sso.ts.com/user/register";
						
						
						
						// $.get(url,data,callback)
						// function方法，其参数result，就是服务器返回的内容
						$.get(url,{"shopName":shopName},function(result){
							$("#msg_shopName").html(result);
						});
					}
				});
...
<div class="login_box">	
					...
					<div class="login_form">
						...
						<form action="http://www.ts.com/managecentre/restaurants/update" method="post" onSubmit="return formObj.checkForm()">
							
							<div class="form_text_ipt" hidden="hidden">
								<input name="restaurantId" type="text" placeholder="商家名称" hidden="hidden" value="${restaurant.restaurantId }">
							</div>
							
							
							<div class="form_text_ipt">
								<input name="shopName" type="text" placeholder="商家名称" value="${restaurant.shopName }">
								<span></span>
							</div>
							
							<div class="form_text_ipt">
								<input name="shopAddress" type="text" placeholder="商家地址" value="${restaurant.shopAddress }">
								<span></span>
							</div>
							
							
							
					        <div class="xiugai"><button>修改</button></div>
