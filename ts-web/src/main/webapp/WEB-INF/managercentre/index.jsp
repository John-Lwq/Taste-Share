...
<style>
	...
	.weibo{background-image:url(../../staticfile/image2/weibo.png);background-size:cover;}
	.weixing{background-image:url(../../staticfile/image2/weixing.png);background-size:cover;}
	.kongjian{background-image:url(../../staticfile/image2/kongjian.png);background-size:cover;}
	.qq{background-image:url(../../staticfile/image2/QQ.png);background-size:cover;}
...
/*	最近预览*/
	...
	/*顶部标签*/
.box_top{width:360px;height:40px;border:1px solid black;margin:0 auto;margin-top:80px;margin-bottom:40px;}
.box_top p{font-size:20px;text-align:center;line-height: 40px;}
/*折扣上方盒子*/
.dis_top_box{width:1320px;margin:0 auto;height:430px;margin-bottom:40px;}
.dis_top_box div{float:left;width:430px;height:430px;overflow:hidden;transition:.5s;}
.dis_top_box div:nth-child(2){margin:0 15px;}
.dis_top_box div:hover{transform:scale(1.1);}
/*折扣下方盒子*/
.dis_bottom{margin:0 auto;width:1320px;overflow:hidden;margin-bottom:80px;}
.bottom_box{width:430px;float:left;height:210px;}
.bottom_box:nth-child(2){margin:0 15px;}
.bottom_box_left{width:210px;height:210px;float:left;position:relative;}
.bottom_box_left:nth-of-type(even){margin-left:10px;}
.juxing{width:150px;height:30px;margin:0 auto;background-color:rgba(204,0,0,0.4);margin-top:130px;}
.dis_bottom .bottom_box .bottom_box_left div{font-size:20px;text-align:center;color:white;line-height:30px;position:absolute;top:0px;left:30px;}

.bottom_box_left{overflow: hidden;}
.bottom_box_left img{transition: 0.3s;}
.bottom_box_left:hover img{transform: scale(1.2);}
</style>
...
<!--顶部标签-->
<div class="dis_top">
<div class="box_top"><a href=""><p>商户用户中心</p></a></div>
</div>
...
<!--折扣上方盒子-->
<div class="dis_top_box">

	<div><a href="http://www.ts.com/managercentre/myrestaurant/${userId}"><img src="../../staticfile/images/box_04.png"></a></div>
	<div><a href="http://www.ts.com/managercentre/mycomment/${userId}"><img src="../../staticfile/images/box_05.png"></a></div>
	<div><a href="http://www.ts.com/managercentre/update/${userId}"><img src="../../staticfile/images/box_06.png"></a></div>
</div>
