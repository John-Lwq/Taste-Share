...
/*商品评价*/
	...
	.fuwu{text-align:center;width:1320px;margin:0 auto;background-image:url(../../staticfile/image2/fuwu.png);background-repeat:no-repeat;
	...
	.baozheng,.tuihuo,.kefu{float:left;background-image:url(../../staticfile/image2/fuwu_baozheng.png);background-repeat:no-repeat;width:calc((100%)/3);text-align:center;background-position:40px center;padding:5px 0;}
	.tuihuo{background-image:url(../../staticfile/image2/fuwu_tuihuo.png);}
	.kefu{background-image:url(../../staticfile/image2/fuwu_kefu.png);}
...
<div class="middle">
      ...
      <div class="one">
		  ...
		  <div class="hengxian_wenzi">商家用户评论</div>
...
<c:forEach  begin="1" end="5" step="1" items="${pageBean.pageList}" var="item">
    <span data-hook="review-body" class="a-size-base review-text">
    <font size="3"  face="宋体">${item.comment}}
