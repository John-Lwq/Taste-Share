...
/*    one-two*/
	...
	.shoucangjia{width:200px;height:50px;border:1px solid black;text-align:center;float:left;background-image:url(../../staticfile/image2/xingxing.png);
...
<div class="one">
<div class="one_one">
	<div class="one_one_tupian" ><img src="${restaurant.defaultPic }" style="width: 300px;"></div>
   <div class="one_bottom">
      <div class="fenxiang">分 享:</div>
      <div class="weibo"></div>
...
<div class="one_two">
  <div class="one_two_top" color:white></div>
  <div class="one_two_bottom" color:white></div>
...
<div class="one_three">
 ...
 <hr/>
 <div class="diaopai">商家：${restaurant.shopName}</div>
 <hr/>
 <div class="diaopai">商家地址：${restaurant.shopAddress}</div>
 <hr/>
 <div class="cuxiao" >人均：￥${restaurant.shopName}  </div>
<hr/>
<div class="shuliang">推荐指数：${restaurant.tasteScore}</div>
<hr/>
<div class="shoucangjia"><a href="">收藏</a></div>

<div class="erweima_wenzi">手机客户端扫一扫购买</div>

<div class="erweima"><img src="../../staticfile/image2/erweima.png"></div>
</div>
<div class="one">

<%-- <c:forEach  begin="0" end="30" step="1" items="${restaurantList}" var="item"> --%>
<c:forEach  begin="0" end="10" step="1" items="${recommend}" var="item">
						
						<div class="one_one">
							<img src="${item.recommendImg}" width="300px" height="300px" />
								<h4>${item.name}</h4>
								<%-- <h5>${item.type}</h5> --%>
								<h6>￥${item.price}</h6>
...
<div class="middle">
      ...
      <div class="one">
		  ...
		  <div class="hengxian_wenzi">评论</div>
...
<c:forEach  begin="1" end="5" step="1" items="${restaurantdesc}" var="item">
    <span data-hook="review-body" class="a-size-base review-text">
    <font size="3"  face="宋体">${item.comment}}</font>
    </span><hr style="width:820px;height:1px;border:none;border-top:1px dashed #0066CC;" /><br/>
	</c:forEach>     
	</div>
	</div>
