...
<style>
	...
	/* 类别框 */
	.right_right dd:hover{text-decoration: underline; font-size: 20px}
	 dl,dt,dd{margin:0;}
	.right{width:986px;float:left;}
	.right_left{padding-left:16px;padding-right:50px;width:80px;line-height:50px;font-weight:bold;float:left;font-size: 17px}
	.yanse .right_left,.pingpai .right_left,.chicun .right_left{padding-left:130px;padding-right:50px;width:80px;line-height:40px;font-weight:bold;float:left;}
	...
	.pingpai{border:1px solid #000}
	.pingpai{height:80px;}
	
    .pingpai dd{float:left;width:150px;}
...
<div class="all">
 <div class="pingpai"> 
              ...
              <div class="right_right">
               <dl>
				   <dd><a href="http://www.ts.com/restaurant/type/1">1）中餐</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/2">2）西餐</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/3">3）烧烤</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/4">4）火锅</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/5">5）海鲜 </a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/6">6）自助餐 </a></dd>
			   </dl>
			   <dl>
				   <dd><a href="http://www.ts.com/restaurant/type/7">7）小吃快餐</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/8">8）日韩料理</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/9">9）面包甜点 </a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/10">10）咖啡厅 </a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/11">11）酒吧</a></dd>
                   <dd><a href="http://www.ts.com/restaurant/type/12">12）其他</a></dd>
			   </dl>
			  </div>
	       </div>
	...
	<table border="0"  cellpadding="0"  cellspacing="0"  width="100%" >
			<tr>
				...
				<table border="0"  cellpadding="1"  cellspacing="2" >
					<tr>
					<td>
						<a class="fenye"  href="${pageBean.pageList[0].type}?currPage=1">
						<img src="../../staticfile/images/table/firstPageDisabled.gif" height="40" width="40" style="border:0"  alt="第一页" />
						</a>
					</td>
					<td>
						<a class="fenye"  href="${pageBean.pageList[0].type}?currPage=${pageBean.currPage-1<=0? 1 : pageBean.currPage-1 }">
						<img src="../../staticfile/images/table/prevPageDisabled.gif" height="40" width="40"  style="border:0"  alt="上一页" />
						</a>
					</td>
					<td>
						<a class="fenye"  href="${pageBean.pageList[0].type}?currPage=${pageBean.currPage+1>=pageBean.totalPage? pageBean.totalPage : pageBean.currPage+1 }">
						<img src="../../staticfile/images/table/nextPage.gif" height="40" width="40"  style="border:0"  title="下一页"  alt="下一页" />
						</a>
					</td>
					<td>
						<a class="fenye"  href="${pageBean.pageList[0].type}?currPage=${pageBean.totalPage }">
