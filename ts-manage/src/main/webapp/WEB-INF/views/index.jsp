	...
	<body>
		<div class="" id="situation">
			...
			<div class="bk-herder relative header-section">
				<div class="bk-herder-logo">Taste&Share后台管理系统</div>
				<div class="operate-header">
					...
					<div class="bk-settings-section">
						<div class="headerUser">
							<a class="user-info clickBombbox" href="javascript:void(0)" data-position="bottom" data-type="arrow"> 欢迎你！！！ <i class="iconfont icon-iconfonticontrianglecopy"></i></a>
							<div class="Bombbox">
							
								<!--欢迎你的下拉列表-->
								<ul class="usercz menulist">
									<li class="column-name">
										<a href="toindex_home" title="系统首页" class="menuUl_title" name="toindex_home" data-id="2"><i class="iconfont icon-home"></i>系统首页</a>
									</li>
							...
							<div class="Bombbox Bombbox-info">
								...
								<ul class="tab_memu box padding10">
									<li class="boxbox-flex2">
										<a href="javascript:void(0)" class="memu_title btn btn-border clickBombbox" data-id="0">待审核</a>
									</li>
									<li class="boxbox-flex2">
									...
									<div class="tab-conent prompt_style ">
										...
										<ul>
											<li class="prompt_info clearfix">
												<a href="javascript:void(0)" class="prompt_link"><em class="iconfont icon_prompt label-danger">&#xe745</em><span class="prompt-xinxi">你有审核还没有处理请及时处理</span></a>
											</li>
											<li class="prompt_info clearfix">
												<a href="javascript:void(0)" class="prompt_link"><em class="iconfont icon_prompt label-danger">&#xe745</em><span class="prompt-xinxi">你有审核还没有处理请及时处理</span></a>
											</li>
				...
				<div class="inte-operation" id="operation">
					...
					<div class="dropdown-menu dropdown-menu-right tab-menu-list" >
						...
						<ul class="tabslist" id="dropdown_menu">
							...
							<li>
								<a class="tabCloseAll" href="javascript:void(0);">全部关闭(除首页)</a>
							</li>
							<li>
...
<script>
	var data = [{
			...
			pid: 0,
			url: "toindex_home", //地址自定义 但需要和homepage保持一致
	...
	$(function() {
		$("#situation").BKframe({
			...
			homepage:"toindex_home", // 设置默认显示页（id值必须为2，否则将出错）
