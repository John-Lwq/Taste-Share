		...
		$("#userId").blur(function() {
			...
			$.ajax({
				...
				success:function (data) {
					//部门编号存在
					if (data.result == "true") {
						$("#checkresult").html("该管理员ID被占用");
					}
					//部门编号不存在
					else {
						$("#checkresult").html("该管理员ID可以使用");
					}
				}
			})
...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<li id="view"><a href="#" onclick="formSubmit('/managerlist','_self')">返回</a></li>
	<li id="new"><a href="#" onclick="formSubmit('/managertoupdate','_self');this.blur();">更新</a></li>
</ul>
  </div>
</div>
</div>
