...
<div id="innerMenubar">
  <div id="navMenubar">
<ul>
	<li id="view"><a href="#" onclick="formSubmit('/userview','_self');this.blur();">查询</a></li>
	<li id="update"><a href="#" onclick="formSubmit('/userupdate','_self');this.blur();">修改</a></li>
	<li id="delete"><a href="#" onclick="formSubmit('/userdelete','_self');this.blur();">删除</a></li>
	<li id="view"><a href="#" onclick="formSubmit('/userdescview','_self');this.blur();">评论</a></li>
</ul>
  </div>
</div>
</div>
		...
		<table border="0"  cellpadding="0"  cellspacing="0"  width="100%" >
			<tr>
				...
				<table border="0"  cellpadding="1"  cellspacing="2" >
					<tr>
					<td>
						<a href="userlist?currentPage=1">
						<img src="images/table/firstPageDisabled.gif"  style="border:0"  alt="第一页" />
						</a>
					</td>
					<td>
						<a href="userlist?currentPage=${pageBean.currPage-1<=0? 1 : pageBean.currPage-1 }">
						<img src="images/table/prevPageDisabled.gif"  style="border:0"  alt="上一页" />
						</a>
					</td>
					<td>
						<a href="userlist?currentPage=${pageBean.currPage+1>=pageBean.totalPage? pageBean.totalPage : pageBean.currPage+1 }">
						<img src="images/table/nextPage.gif"  style="border:0"  title="下一页"  alt="下一页" />
						</a>
					</td>
					<td>
						<a href="userlist?currentPage=${pageBean.totalPage }">
